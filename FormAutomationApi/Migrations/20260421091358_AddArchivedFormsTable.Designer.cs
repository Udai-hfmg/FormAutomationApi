...
namespace FormAutomationApi.Migrations
{
    ...
    [Migration("20260421091358_AddArchivedFormsTable")]
    partial class AddArchivedFormsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArchiveForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.PrimitiveCollection<string>("FacilityIds")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.PrimitiveCollection<string>("FormIds")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("FormAutomationApi.Model.FormSubmission", b =>
                {
            ...
            modelBuilder.Entity("FormAutomationApi.Model.IntakePacket", b =>
                {
                    ...
                    b.Property<DateTime?>("PacketDate")
                        .HasColumnType("datetime(6)");
                    ...
                    b.ToTable("intakepacket", (string)null);
                });

            modelBuilder.Entity("FormAutomationApi.Model.PatientSignature", b =>
                {
                    b.Property<int>("PatientSignatureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("PatientSignatureId"));
                    ...
                    b.HasKey("PatientSignatureId");

                    b.HasIndex("PatientId");

                    b.ToTable("patientsignature", (string)null);
                });
            ...
            modelBuilder.Entity("PatientPharmacy", b =>
                {
                    ...
                    b.ToTable("patientpharmacy", (string)null);
                });
            ...
            modelBuilder.Entity("SignedDocument", b =>
                {
                    ...
                    b.Property<string>("RepresentativeAuthority")
                        .HasColumnType("longtext");
